...
class BundledProductsProductCard extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <ProductCard>
        ...
        {/* <img src={product.product_details && product.product_details.custom && product.product_details.custom.thumbnail || defaultImage } /> */}
...
export default BundledProductsProductCard;
