...
class CourseCustomFields extends Component {
        ...
        this.props.productSaveCustomFields({
          ...
          onSuccess: () => {
            this.setState({isSaving:false}, ()=>{
              message.success("Course custom fields updated!");
            });
        ...
        <Form>
          ...
          <Row>
            <Col span={24}>
              <TextInput
                form={form}
                label="Thinkific Course Link"
                name="course_link"
                onChange={e => this.handleChange("course_link", e)}
                required={true}
                min={3}
                max={50}
                initialValue={customFields.course_link}
              />
            </Col>
          </Row>
          <Row>
...
export default Form.create()(CourseCustomFields);
