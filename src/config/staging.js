export default {
  ...
  AUTH0_CALLBACK: "https://dev.istack.network/auth",
  AUTH0_NAMESPACE: "https://istacktraining.com/",
  AUTH0_ACCOUNTS: "istack_accounts",
  AUTH0_REDIRECT_CART: "https://dev.istack.network/cart",
  AUTH0_REDIRECT_SHOP: "https://dev.istack.network/shop",
  API_URL: "https://dev-api.istack.network",
  AUTH0_DATABASE: "iStack-Network-Staging",
  APP_BRAND: "istack-network",
  APP_ROOT: "https://dev.istack.network",
  MENU_CUSTOMER:  [
    {
